...
@Component({
  selector: 'app-post-strength-update',
  templateUrl: './post-strength-update.component.html',
  styleUrls: ['./post-strength-update.component.scss']
})
export class PostStrengthUpdateComponent implements OnInit {
  ...
  initForm() {
    this.dataForm = this.formBuilder.group({
      cCompetence: ['', Validators.required],
      eCompetence: ['', Validators.required],
      aydCompetence: ['', Validators.required],
    })
  }
  ...
  addToCompetences() {
    this.psicosocialService.addCompetencesToEnlistment(this.dataForm.value).subscribe({
      next: () => {
        this.alertService.success('¡Correcto!', 'Fortalecimiento creado.');
        this.location.back();
        this.dataForm.reset();
      }
    })
