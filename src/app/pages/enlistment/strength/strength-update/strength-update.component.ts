...
@Component({
  selector: 'app-strength-update',
  templateUrl: './strength-update.component.html',
  styleUrls: ['./strength-update.component.scss']
})
export class StrengthUpdateComponent {
  ...
  addToCompetences() {
    this.enlistmentService.addCompetencesToEnlistment(this.dataForm.value).subscribe({
      next: () => {
